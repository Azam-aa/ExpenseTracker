/**
 * ID generation and RFC 6234 standard SHA-256 hashing with universal fallback
 * Works in secure contexts (HTTPS/localhost) and non-secure contexts (HTTP over local Wi-Fi)
 */
...
// Compute SHA-256 hex digest using Web Crypto API with robust pure JS fallback
